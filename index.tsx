...
import { InputProps, OTPInputViewState } from '@hichembaali/react-native-otp-input';
...
export default class OTPInputView extends Component<InputProps, OTPInputViewState> {
    ...
    renderOneInputField = (_: TextInput, index: number) => {
        ...
        const codeInputStyle = digits[index] ?  codeInputAlreadyFieldStyle : codeInputFieldStyle
        return (
